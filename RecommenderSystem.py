...
class ContentBasedRecommender:
    ...
    def __init__(self, mapping_matrix: pd.DataFrame, ratings: pd.DataFrame, description_matrix: np.array = None, title_matrix: np.array = None, movie_info_matrix: np.array = None, cast_info_matrix: np.array = None, scaling_function=sklearn.preprocessing.normalize, scaling_kwargs={'norm': 'max', 'axis': 0}):
    ...
    def recommend(self, metric: str = "cosine"):
        ...
        '''
        # check shape
        print(self.utility_matrix.shape, self.item_matrix.shape)
